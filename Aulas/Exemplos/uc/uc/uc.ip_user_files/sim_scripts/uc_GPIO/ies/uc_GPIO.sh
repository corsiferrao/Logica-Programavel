...
compile()
{
  ...
  ncvhdl -work microblaze_v9_5_2 $opts_vhd \
  ...
  ncvlog -work xil_defaultlib $opts_ver +incdir+"$ref_dir/../../../../uc.srcs/sources_1/bd/uc_GPIO/ipshared/xilinx.com/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" \
  ...
  ncvlog -work generic_baseblocks_v2_1_0 $opts_ver +incdir+"$ref_dir/../../../../uc.srcs/sources_1/bd/uc_GPIO/ipshared/xilinx.com/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" \
  ...
  ncvlog -work axi_infrastructure_v1_1_0 $opts_ver +incdir+"$ref_dir/../../../../uc.srcs/sources_1/bd/uc_GPIO/ipshared/xilinx.com/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" \
  ...
  ncvlog -work axi_register_slice_v2_1_6 $opts_ver +incdir+"$ref_dir/../../../../uc.srcs/sources_1/bd/uc_GPIO/ipshared/xilinx.com/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" \
  ...
  ncvlog -work axi_data_fifo_v2_1_5 $opts_ver +incdir+"$ref_dir/../../../../uc.srcs/sources_1/bd/uc_GPIO/ipshared/xilinx.com/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" \
  ...
  ncvlog -work axi_crossbar_v2_1_7 $opts_ver +incdir+"$ref_dir/../../../../uc.srcs/sources_1/bd/uc_GPIO/ipshared/xilinx.com/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" \
...
elaborate()
{
  ...
  libs="-libname unisims_ver -libname unimacro_ver -libname secureip -libname microblaze_v9_5_2 -libname xil_defaultlib -libname lmb_v10_v3_0_7 -libname lmb_bram_if_cntlr_v4_0_7 -libname blk_mem_gen_v8_3_0 -libname axi_lite_ipif_v3_0_3 -libname mdm_v3_2_4 -libname lib_cdc_v1_0_2 -libname proc_sys_reset_v5_0_8 -libname interrupt_control_v3_1_2 -libname axi_gpio_v2_0_8 -libname generic_baseblocks_v2_1_0 -libname axi_infrastructure_v1_1_0 -libname axi_register_slice_v2_1_6 -libname fifo_generator_v13_0_0 -libname axi_data_fifo_v2_1_5 -libname axi_crossbar_v2_1_7"
  ncelab $opts xil_defaultlib.uc_GPIO xil_defaultlib.glbl $libs
}
...
simulate()
{
  ...
  ncsim $opts xil_defaultlib.uc_GPIO -input simulate.do
}
# Script usage
usage()
{
