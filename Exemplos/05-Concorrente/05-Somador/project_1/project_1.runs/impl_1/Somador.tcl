...
set rc [catch {
  ...
  open_checkpoint Somador_routed.dcp
  write_bitstream -force Somador.bit 
  if { [file exists /home/rafa/Dropbox/Aulas/Pos/2014/LogicaProgramavel/05-Concorrente/project_1/project_1.runs/synth_1/Somador.hwdef] } {
    catch { write_sysdef -hwdef /home/rafa/Dropbox/Aulas/Pos/2014/LogicaProgramavel/05-Concorrente/project_1/project_1.runs/synth_1/Somador.hwdef -bitfile Somador.bit -meminfo Somador_bd.bmm -file Somador.sysdef }
  }
