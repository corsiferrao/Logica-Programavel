...
xelab -m64 --debug typical --relax -L xil_defaultlib -L secureip --snapshot tb_behav --prj /home/rafa/07-latch-flipflop/07-latch-flipflop.sim/sim_1/behav/tb.prj   xil_defaultlib.tb
if errorlevel 1 (
